...
## Upload parsing for the Methylomics Dataset tab (shiny_app/R/mod_methyl_dataset.R).
## Matrix/sample-sheet parsing never throws - each returns
## list(ok = FALSE, error = <message>) instead, the same fail-soft sentinel
## pattern shiny_app/R/mod_dataset.R and mod_preprocessing_explore.R already
