...
source_from_app_root(file.path("R", "multiomics", "multiomics_live_plots.R"))
source_from_app_root(file.path("R", "multiomics", "multiomics_integration_live_helpers.R"))
source_from_app_root(file.path("R", "multiomics", "multiomics_integration_live_plots.R"))
source_from_app_root(file.path("R", "multiomics", "cohort_harmonization_helpers.R"))
source_from_app_root(file.path("R", "multiomics", "mod_multi_integration.R"))  ## defines shared mi_warn()/mi_ok()/mi_stop()/mi_stat_card()
source_from_app_root(file.path("R", "multiomics", "snf_clustering_helpers.R"))
source_from_app_root(file.path("R", "multiomics", "snf_clustering_plots.R"))
source_from_app_root(file.path("R", "multiomics", "mod_multi_stratification.R"))
