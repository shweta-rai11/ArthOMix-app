...
source_from_app_root(file.path("R", "multiomics", "mod_multi_integration.R"))  ## shared mi_warn()/mi_ok()/mi_stop()
source_from_app_root(file.path("R", "multiomics", "multiomics_biomarker_helpers.R"))
source_from_app_root(file.path("R", "multiomics", "multiomics_biomarker_plots.R"))
source_from_app_root(file.path("R", "multiomics", "multiomics_sexstratified_engine.R"))
source_from_app_root(file.path("R", "multiomics", "mod_multi_biomarker.R"))
